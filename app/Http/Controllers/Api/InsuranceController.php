...
class InsuranceController extends Controller
{
    ...
    public function store(Request $request, Vehicle $vehicle)
    {
        ...
        $validatedData = $request->validate(['vehicle_class_snapshot' => 'nullable|string|max:255', 'insurance_type' => 'nullable|string|max:255', 'company_name' => 'nullable|string|max:255', 'policy_number' => 'nullable|string|max:255', 'start_date' => 'nullable|date', 'end_date' => 'nullable|date', 'status' => 'nullable|string|max:50', 'file' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',]);
