...
class PuccController extends Controller
{
    ...
    public function store(Request $request, Vehicle $vehicle)
    {
        ...
        $validatedData = $request->validate(['pucc_number' => 'nullable|string|max:255', 'valid_from' => 'nullable|date', 'valid_until' => 'nullable|date', 'status' => 'nullable|string|max:50', 'file' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:2048',]);
